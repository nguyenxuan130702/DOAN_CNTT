<template>
    <div class="form_course" id="form_news_detail">
        <div class="form_course_title">
            <h1>Thôn tin chi tiết bản tin</h1>
            <div id="bugg"></div>
        ...
        <div class="form_course-content-x">
            ...
            <div class="a-new-content">
                <b>Nội dung</b> <br>
                <div class="scoll-noidung">{{noidung}}</div>
            </div>
        </div>
    </div>
</template>
...
export default{
    ...
    methods: {
        closeFormPutNew: function(){
            document.getElementById('form_news_detail').style.display = "none"; 
