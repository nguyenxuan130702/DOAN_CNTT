<template>
    <div class="import-excel" id="import-excel">
            ...
            <table>
                ...
                <tbody>
                    <tr v-for="(item, index) in question" :key="index">
                        <td style="width: 80px;">{{ item.questionCode }}</td>
                        ...
                        <td style="width: 200px;">{{ item.lessonId }}</td>
            ...
            if(this.buoc1){ 
                ...
                if(this.file === undefined || this.file === null){
                    ...
                    if(this.previousFile !== this.file){
                        document.getElementById("check_import").innerHTML = "Gọi api"; 
                        const fromFile = new FormData(); 
                        fromFile.append("excelFile", this.file); 

                        BaseRequest.post("question/import", fromFile)
                        .then(response => {
                        ...
                        document.getElementById("check_import").innerHTML = "Không gọi api"; 
                    }
